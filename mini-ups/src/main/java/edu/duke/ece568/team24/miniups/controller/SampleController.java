...
// public SampleController(AccountService accountService, OrderService
// orderService, PackageService packageService, TruckService truckService) {
...
// // AccountDto accountDto = accountService.createAccount("david", "123456",
// "ADMIN", "david123@gmail.com");
// // AccountDto accountDto2 = accountService.createAccount("mary", "123456",
// "USER", "mary234@gmail.com");
...
// PackageDto packageDto1 = packageService.createPackage(630, "shampoo",
// orderDto1, truckDtoList.get(0));
// PackageDto packageDto2 = packageService.createPackage(631, "soap", orderDto1,
// truckDtoList.get(0));
// PackageDto packageDto3 = packageService.createPackage(632, "gloves",
// orderDto1, truckDtoList.get(0));

// PackageDto packageDto4 = packageService.createPackage(634, "dog food",
// orderDto2, truckDtoList.get(0));
