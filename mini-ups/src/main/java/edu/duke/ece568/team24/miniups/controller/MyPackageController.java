...
import static edu.duke.ece568.team24.miniups.model.myenum.MyPackageStatus.DELIVERED;
...
//        Account account = new Account(1L, "david green", "123456", "david123@gmail.com", "ADMIN");
        ...
        MyPackage mypackage = new MyPackage(630, "shampoo", DELIVERED, 5, 7, myorder, truck);
        mypackageService.createMyPackage(mypackage);
        MyPackage mypackage2 = new MyPackage(631, "soap", DELIVERED, 5, 7, myorder, truck);
        mypackageService.createMyPackage(mypackage2);
        MyPackage mypackage3 = new MyPackage(632, "gloves", DELIVERED, 5, 7, myorder, truck);
